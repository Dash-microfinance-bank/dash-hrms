...
import { DeleteDepartmentConfirmModal } from '@/components/dashboard/DeleteDepartmentConfirmModal'
    ...
    () => [
      ...
      },
      {
        ...
        cell: ({ row }) => {
          ...
          const display =
            code && code.trim().length > 0 ? `${name} (${code.trim()})` : name
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem
                ...
                onClick={() => setDeletingDepartment(row.original)}
              >
                Delete
              </DropdownMenuItem>
            </DropdownMenuContent>
      ...
      {rows.length > 0 && (
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-xs text-muted-foreground">
            Showing {rows.length} of {data.length} departments
          </p>
